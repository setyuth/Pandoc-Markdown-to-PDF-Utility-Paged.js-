...
set "CMD=%CMD% --from markdown+hard_line_breaks"
set "CMD=%CMD% --markdown-headings=atx"
set "CMD=%CMD% --wrap=preserve"
set "CMD=%CMD% --css themes/%THEME%.css"
set "CMD=%CMD% --include-in-header=header-footer.html"
set "CMD=%CMD% --include-before-body=_date_stamp.html"
@REM set "CMD=%CMD% --metadata title="%BASENAME%""
@REM set "CMD=%CMD% --metadata author="%AUTHOR%""
@REM set "CMD=%CMD% --metadata date="%TODAY% %TIME%""
